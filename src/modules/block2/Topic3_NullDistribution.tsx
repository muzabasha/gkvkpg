        ...
        {openSections.sec3 && (
          <div className="p-6 space-y-4 text-sm">
            <div className="p-4 bg-brandDark-50 dark:bg-brandDark-950 rounded-xl">
              <h5 className="font-bold">Level 1 — Teacher Do: P-Value Calculations</h5>
              <p className="mt-1">
                The teacher demonstrates the F-scaling transformation on the blackboard. By entering mock numbers ($T^2 = 12$, $n=25$, $p=2$), the teacher shows how the scaled $F \approx 5.48$ is evaluated against standard F-tables.
              </p>
            </div>
          </div>
        )}
