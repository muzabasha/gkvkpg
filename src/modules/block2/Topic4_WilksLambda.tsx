      ...
      <section className="bg-white dark:bg-brandDark-900 border border-brandDark-200 dark:border-brandDark-800 rounded-2xl overflow-hidden shadow-sm">
        ...
        {openSections.sec3 && (
          <div className="p-6 text-sm">
            <p>
              Students work in groups to construct small 2x2 datasets representing test scores of two classrooms. They manually calculate determinants and observe how shifting group averages affects Wilks' Lambda.
            </p>
          </div>
        )}
      </section>
