        ...
        {openSections.sec3 && (
          <div className="p-6 space-y-6">
            ...
            <div className="p-5 rounded-xl border border-brandDark-100 dark:border-brandDark-800/80 bg-brandDark-50/50 dark:bg-brandDark-950/10">
              ...
              <p className="text-sm">
                <strong>Objectives:</strong> Establish foundational intuition for Factor Analysis.
              </p>
              <div className="text-sm space-y-2 mt-2 pl-3 border-l-2 border-brandDark-200 dark:border-brandDark-700">
                ...
                <p><strong>Step 2:</strong> Walk through a real-world scenario demonstrating how Factor Analysis solves the problem.</p>
              </div>
            </div>
            ...
            <div className="p-5 rounded-xl border border-brandDark-100 dark:border-brandDark-800/80 bg-brandDark-50/50 dark:bg-brandDark-950/10">
              ...
              <p className="text-sm">
                <strong>Objectives:</strong> Guided formulation of Factor Analysis components.
              </p>
              <p className="text-sm">
            ...
            <div className="p-5 rounded-xl border border-brandDark-100 dark:border-brandDark-800/80 bg-brandDark-50/50 dark:bg-brandDark-950/10">
              ...
              <p className="text-sm">
                <strong>Objectives:</strong> Relate Factor Analysis theory to practical outputs.
              </p>
              <p className="text-sm">
            ...
            <div className="p-5 rounded-xl border border-brandDark-100 dark:border-brandDark-800/80 bg-brandDark-50/50 dark:bg-brandDark-950/10">
              ...
              <p className="text-sm">
                <strong>Task:</strong> Compute a tiny 2x2 problem related to Factor Analysis.
              </p>
              <p className="text-sm">
