        ...
        {openSections.sec3 && (
          <div className="p-6 space-y-4 text-sm">
            <div className="p-4 bg-brandDark-50 dark:bg-brandDark-950 rounded-xl">
              <h5 className="font-bold">Level 1 — Teacher Do: Classroom Tile Walk</h5>
              <p className="mt-1">
                The teacher walks diagonally across classroom floor tiles to demonstrate straight-line Euclidean distance. The teacher then walks strictly along the grout lines (forming a grid) to show Manhattan distance, highlighting how metric rules change paths.
              </p>
            </div>
          </div>
        )}
