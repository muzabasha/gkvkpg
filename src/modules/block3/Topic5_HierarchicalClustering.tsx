        ...
        {openSections.sec3 && (
          <div className="p-6 space-y-4 text-sm">
            <div className="p-4 bg-brandDark-50 dark:bg-brandDark-950 rounded-xl">
              <h5 className="font-bold">Level 1 — Teacher Do: Group Clustering</h5>
              <p className="mt-1">
                The teacher places 4 mock item cards on the board. The teacher demonstrates the step-by-step bottom-up merge sequence under Single Linkage vs Complete Linkage, drawing the resulting tree (dendrogram) live.
              </p>
            </div>
          </div>
        )}
